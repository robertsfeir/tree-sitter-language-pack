...
// alef:hash:019ff7052866944c064006a6235a358fe9160bcdb41e35977c5802ad32d18b9e
...
pub extern "C" fn get_module() -> *mut ::ext_php_rs::zend::ModuleEntry {
    ...
    __EXT_PHP_RS_MODULE_ENTRY.get_or_init(|| {
        let builder = ::ext_php_rs::builders::ModuleBuilder::new("tree_sitter_language_pack", "2.0.0")
