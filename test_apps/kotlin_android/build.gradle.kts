...
dependencies {
    ...
    implementation("io.xberg.tslp.android:tree-sitter-language-pack-android:1.17.0")
    // Jackson for JSON assertion helpers
    testImplementation("com.fasterxml.jackson.core:jackson-annotations:2.22.2")
...
tasks.register("verifyAarPublished") {
    ...
    doLast {
        val aarCoord = "io.xberg.tslp.android:tree-sitter-language-pack-android:1.17.0"
