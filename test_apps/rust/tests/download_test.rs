...
// alef:hash:a2c51e7205d704f7874dd7d49f101967cd040c7f2c982fa2a3d77a5103fa03d9
...
fn test_download_cache_dir() {
    ...
    let result = cache_dir().expect("call failed");
...
fn test_download_clean_cache() {
    ...
    clean_cache().expect("call failed");
}
...
fn test_download_configure_custom_dir() {
    ...
    configure(&config).expect("call failed");
}
...
fn test_download_empty_list() {
    ...
    let result = download(&names_refs).expect("call failed");
...
fn test_download_init_default() {
    ...
    let config = serde_json::from_value(config_json).unwrap();
    init(&config).expect("call failed");
}
...
fn test_prefetch_empty_list() {
    ...
    prefetch(&languages_refs).expect("call failed");
}
