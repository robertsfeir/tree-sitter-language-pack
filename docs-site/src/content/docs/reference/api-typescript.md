...
<!-- alef:hash:fffdbdca06dc247406adfcd43b6fa719c2d1989a6208f0e2e66f07db22ddba6f -->
<!-- To regenerate: alef docs -->
<!-- To verify freshness: alef verify -->

## TypeScript API Reference <span class="version-badge">v1.17.0</span>
...
```typescript
function manifestGroups(): Array<string>
```

**Example:**

```typescript
const result = manifestGroups();
```
