...
// alef:hash:4dbcc4802dc75082829918abea1b5dbfaafca7bbf59bc49905b424b6ca9b0c13
...
impl CommentInfo {
    fn new(args: &[magnus::Value]) -> Result<Self, magnus::Error> {
        ...
        Ok(Self {
            ...
            associated_node: match kwargs.get(ruby.to_symbol("associated_node")).filter(|v| !v.is_nil()) {
...
impl<'de> serde::Deserialize<'de> for DataNode {
...
impl DataNode {
    fn new(args: &[magnus::Value]) -> Result<Self, magnus::Error> {
        ...
        Ok(Self {
            ...
            key: match kwargs.get(ruby.to_symbol("key")).filter(|v| !v.is_nil()) {
                Some(v) => Some(String::try_convert(v).map_err(|e| {
                    magnus::Error::new(
                        unsafe { magnus::Ruby::get_unchecked() }.exception_type_error(),
            ...
            value: match kwargs.get(ruby.to_symbol("value")).filter(|v| !v.is_nil()) {
                Some(v) => Some(String::try_convert(v).map_err(|e| {
                    magnus::Error::new(
                        unsafe { magnus::Ruby::get_unchecked() }.exception_type_error(),
                        format!("invalid value for `value`: {}", e),
...
impl<'de> serde::Deserialize<'de> for DocstringInfo {
    fn deserialize<D>(deserializer: D) -> ::core::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
...
impl DocstringInfo {
    fn new(args: &[magnus::Value]) -> Result<Self, magnus::Error> {
        ...
        Ok(Self {
            ...
            associated_item: match kwargs.get(ruby.to_symbol("associated_item")).filter(|v| !v.is_nil()) {
                Some(v) => Some(String::try_convert(v).map_err(|e| {
                    magnus::Error::new(
                        unsafe { magnus::Ruby::get_unchecked() }.exception_type_error(),
...
impl<'de> serde::Deserialize<'de> for ImportInfo {
    fn deserialize<D>(deserializer: D) -> ::core::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
...
impl ImportInfo {
    fn new(args: &[magnus::Value]) -> Result<Self, magnus::Error> {
        ...
        Ok(Self {
            ...
            alias: match kwargs.get(ruby.to_symbol("alias")).filter(|v| !v.is_nil()) {
                Some(v) => Some(String::try_convert(v).map_err(|e| {
                    magnus::Error::new(
                        unsafe { magnus::Ruby::get_unchecked() }.exception_type_error(),
...
impl<'de> serde::Deserialize<'de> for PackConfig {
    fn deserialize<D>(deserializer: D) -> ::core::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
...
impl PackConfig {
    fn new(args: &[magnus::Value]) -> Result<Self, magnus::Error> {
        ...
        Ok(Self {
            ...
            languages: match kwargs.get(ruby.to_symbol("languages")).filter(|v| !v.is_nil()) {
            ...
            groups: match kwargs.get(ruby.to_symbol("groups")).filter(|v| !v.is_nil()) {
                Some(v) => Some(<Vec<String>>::try_convert(v).map_err(|e| {
                    magnus::Error::new(
                        unsafe { magnus::Ruby::get_unchecked() }.exception_type_error(),
...
impl Parser {
    fn set_max_source_bytes(&self, max_bytes: Option<usize>) -> () {
        self.inner.lock().unwrap().set_max_source_bytes(max_bytes)
    }

    fn set_parse_timeout_ms(&self, timeout_ms: Option<u64>) -> () {
        self.inner.lock().unwrap().set_parse_timeout_ms(timeout_ms)
    }
...
impl ProcessConfig {
    fn new(args: &[magnus::Value]) -> Result<Self, magnus::Error> {
        ...
        Ok(Self {
            ...
            chunk_max_size: match kwargs.get(ruby.to_symbol("chunk_max_size")).filter(|v| !v.is_nil()) {
            ...
            max_source_bytes: match kwargs.get(ruby.to_symbol("max_source_bytes")).filter(|v| !v.is_nil()) {
                Some(v) => Some(usize::try_convert(v).map_err(|e| {
                    magnus::Error::new(
                        unsafe { magnus::Ruby::get_unchecked() }.exception_type_error(),
            ...
            parse_timeout_ms: match kwargs.get(ruby.to_symbol("parse_timeout_ms")).filter(|v| !v.is_nil()) {
    ...
    fn max_source_bytes(&self) -> Option<usize> {
        self.max_source_bytes
    }

    fn parse_timeout_ms(&self) -> Option<u64> {
    ...
    fn with_max_source_bytes(&self, max_bytes: Option<usize>) -> ProcessConfig {
        #[allow(clippy::needless_update)]
        let core_self = tree_sitter_language_pack::ProcessConfig {
            language: self.language.clone().into(),
        ...
        core_self.with_max_source_bytes(max_bytes).into()
    }

    fn with_parse_timeout_ms(&self, timeout_ms: Option<u64>) -> ProcessConfig {
        #[allow(clippy::needless_update)]
        let core_self = tree_sitter_language_pack::ProcessConfig {
            language: self.language.clone().into(),
        ...
        core_self.with_parse_timeout_ms(timeout_ms).into()
    }
...
impl<'de> serde::Deserialize<'de> for ProcessResult {
    fn deserialize<D>(deserializer: D) -> ::core::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
...
impl<'de> serde::Deserialize<'de> for StructureItem {
    fn deserialize<D>(deserializer: D) -> ::core::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
...
impl StructureItem {
    fn new(args: &[magnus::Value]) -> Result<Self, magnus::Error> {
        ...
        Ok(Self {
            ...
            visibility: match kwargs.get(ruby.to_symbol("visibility")).filter(|v| !v.is_nil()) {
                Some(v) => Some(String::try_convert(v).map_err(|e| {
                    magnus::Error::new(
                        unsafe { magnus::Ruby::get_unchecked() }.exception_type_error(),
            ...
            doc_comment: match kwargs.get(ruby.to_symbol("doc_comment")).filter(|v| !v.is_nil()) {
                Some(v) => Some(String::try_convert(v).map_err(|e| {
                    magnus::Error::new(
                        unsafe { magnus::Ruby::get_unchecked() }.exception_type_error(),
            ...
            signature: match kwargs.get(ruby.to_symbol("signature")).filter(|v| !v.is_nil()) {
                Some(v) => Some(String::try_convert(v).map_err(|e| {
                    magnus::Error::new(
                        unsafe { magnus::Ruby::get_unchecked() }.exception_type_error(),
            ...
            body_span: match kwargs.get(ruby.to_symbol("body_span")).filter(|v| !v.is_nil()) {
...
impl SymbolInfo {
    fn new(args: &[magnus::Value]) -> Result<Self, magnus::Error> {
        ...
        Ok(Self {
            ...
            type_annotation: match kwargs.get(ruby.to_symbol("type_annotation")).filter(|v| !v.is_nil()) {
                Some(v) => Some(String::try_convert(v).map_err(|e| {
                    magnus::Error::new(
                        unsafe { magnus::Ruby::get_unchecked() }.exception_type_error(),
            ...
            doc: match kwargs.get(ruby.to_symbol("doc")).filter(|v| !v.is_nil()) {
                Some(v) => Some(String::try_convert(v).map_err(|e| {
                    magnus::Error::new(
                        unsafe { magnus::Ruby::get_unchecked() }.exception_type_error(),
...
impl magnus::TryConvert for DataNodeKind {
    fn try_convert(val: magnus::Value) -> Result<Self, magnus::Error> {
        ...
        // existing consumer code written in any of those styles keep working.
        match s.as_str() {
            "KeyValue" | "key_value" => Ok(DataNodeKind::KeyValue),
...
impl magnus::TryConvert for ExportKind {
    fn try_convert(val: magnus::Value) -> Result<Self, magnus::Error> {
        ...
        match s.as_str() {
            ...
            "ReExport" | "re_export" => Ok(ExportKind::ReExport),
            other => Err(magnus::Error::new(
                unsafe { Ruby::get_unchecked() }.exception_arg_error(),
...
#[cfg(feature = "download")]
fn manifest_groups() -> Result<Vec<String>, Error> {
    let result = tree_sitter_language_pack::manifest_groups().map_err(|e| {
        magnus::Error::new(
            unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
            e.to_string(),
        )
...
impl From<ProcessConfig> for tree_sitter_language_pack::ProcessConfig {
    fn from(val: ProcessConfig) -> Self {
        Self {
            ...
            max_source_bytes: val.max_source_bytes,
            parse_timeout_ms: val.parse_timeout_ms,
            ..Default::default()
        }
    }
}
...
fn ruby_init(ruby: &Ruby) -> Result<(), Error> {
    ...
    class.define_method("set_max_source_bytes", method!(Parser::set_max_source_bytes, 1))?;

    class.define_method("set_parse_timeout_ms", method!(Parser::set_parse_timeout_ms, 1))?;
    ...
    class.define_method("max_source_bytes", method!(ProcessConfig::max_source_bytes, 0))?;

    class.define_method("parse_timeout_ms", method!(ProcessConfig::parse_timeout_ms, 0))?;
    ...
    class.define_method(
        ...
        method!(ProcessConfig::with_max_source_bytes, 1),
    )?;

    class.define_method(
        "with_parse_timeout_ms",
        method!(ProcessConfig::with_parse_timeout_ms, 1),
    )?;

    class.define_method("validate", method!(ProcessConfig::validate, 0))?;
    ...
    #[cfg(feature = "download")]
    module.define_module_function("manifest_groups", function!(manifest_groups, 0))?;
